...
void goToStart() {
    ...
    unsigned short colors[7] = {((22&31) | (6&31) << 5 | (13&31) << 10), ((28&31) | (8&31) << 5 | (16&31) << 10), ((31&31) | (13&31) << 5 | (21&31) << 10), ((31&31) | (20&31) << 5 | (26&31) << 10), ((18&31) | (19&31) << 5 | (27&31) << 10), ((5&31) | (26&31) << 5 | (25&31) << 10), ((0&31) | (21&31) << 5 | (20&31) << 10)};
    int col = 84;
    int spacing = 12;
    for(int i = 0; i < 7; i++){
    ...
    drawString(84, 96, "spring 2023", ((28&31) | (29&31) << 5 | (30&31) << 10));
...
void start() {
    ...
    *(volatile u16*)0x04000068 = (((0) & 15) << 12) | (0 << 11) | (((0) & 7) << 8) | (2 << 6);
    *(volatile u16*)0x0400006C = NOTE_G6 | (1<<15) | (1<<14);
    *(volatile u16*)0x04000060 = ((0) & 7) | (((0) & 7) << 4) | (1 << 3);
}
...
void game() {
    ...
    mgba_open();
    waitForVBlank();
    drawRect(210, 1, 50, 8, ((0&31) | (0&31) << 5 | (0&31) << 10));
    drawString(210, 1, buffer, ((31&31) | (31&31) << 5 | (31&31) << 10));
    drawGame();
...
void goToGame() {
    fillScreen(((0&31) | (0&31) << 5 | (0&31) << 10));
    drawString(175, 1, "SCORE:", ((31&31) | (31&31) << 5 | (31&31) << 10));
    state = GAME;
}

void goToPause() {
    fillScreen(((0&31) | (0&31) << 5 | (0&31) << 10));
    drawString(136, 8, "GAME IS PAUSED", ((22&31) | (6&31) << 5 | (13&31) << 10));
    drawString(130, 18, "CURRENT SCORE: ", ((22&31) | (6&31) << 5 | (13&31) << 10));
    waitForVBlank();
    state = PAUSE;
}
...
void pause() {
    ...
    *(volatile u16*)0x04000068 = (((5) & 15) << 12) | (0 << 11) | (((0) & 7) << 8) | (2 << 6);
    *(volatile u16*)0x0400006C = NOTE_G6 | (1<<15);
    *(volatile u16*)0x04000060 = ((7) & 7) | (((0) & 7) << 4) | (1 << 3);
}

void goToLose() {
    fillScreen(((0&31) | (0&31) << 5 | (0&31) << 10));
    drawString(136, 8, "GAME OVER", ((22&31) | (6&31) << 5 | (13&31) << 10));
    drawString(130, 18, "YOUR SCORE: ", ((22&31) | (6&31) << 5 | (13&31) << 10));
    drawString(130, 28, "HIGH SCORE: ", ((22&31) | (6&31) << 5 | (13&31) << 10));
    sprintf(buffer, "%d", score);
    drawString(195, 18, buffer, ((31&31) | (31&31) << 5 | (31&31) << 10));
    sprintf(buffer, "%d", highScore);
    drawString(195, 28, buffer, ((31&31) | (31&31) << 5 | (31&31) << 10));
    state = LOSE;
}
